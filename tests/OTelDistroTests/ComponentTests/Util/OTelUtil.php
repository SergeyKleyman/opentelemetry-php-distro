...
final class OTelUtil
{
    ...
    {
        return AppCodeContextUtil::adaptClassNameScoping(Globals::class)::tracerProvider()->getTracer(name: 'org.opentelemetry.php.distro.component-tests', version: Version::VERSION_1_27_0->value);
    }
    ...
    {
        return AppCodeContextUtil::adaptClassNameScoping(Context::class);
    }
    ...
    {
        return AppCodeContextUtil::adaptClassNameScoping(OTelApiSpan::class);
    }
